        ...
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>
                {invoices.length
                  ? invoices[0].user.first_name + "'s Transactions"
                  : null}
              </BlockTitle>
            ...
            <BlockHeadContent className="d-flex flex-column align-items-end">
              <Link to={`/admin/customer`}>
                <Button
                  color="light"
                  outline
                  className="bg-white d-none d-sm-inline-flex mb-3"
                >
                            ...
                            <tr className="tb-odr-item" key={item.id}>
                              <td className="tb-odr-info">
                                <span className="tb-odr-id">
                                  <Link
                                    to={`/admin/invoice-details/${item.invoice_id}?userId=${user_id}`}
                                  >
                                    {item.invoice_id}
                                  </Link>
                                </span>
